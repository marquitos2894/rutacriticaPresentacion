...
<script type="text/javascript" src="sistema/js/jquery-ui-1.10.4.custom.js"></script>
...
<script type="text/javascript">	
	...
	function Actividad(vA,vB,vC,vD,vE,vF,vG,vH) {
	    this.A = vA;
	    this.B = vB;
	    this.C = vC;
	    this.D = vD;
	...
	function test2() {
	    ...
	    var mObj = new Object;
	    mObj.Actividades = tmp;
	    objJSON = JSON.stringify(mObj);
	    //console.log(objJSON);
	}
	...
	$(document).ready(function(){
	    ...
	    $("#btnProcesar").click(function(){
	        ...
	        getData();
	        test2();
	        var arreglo = JSON.stringify(arr);
	         $.ajax({
		        url: 'sistema/principal.php',
		        type: 'POST',
		        data: { arreglo: objJSON },
	             datatype: 'json',
		        cache: false,
